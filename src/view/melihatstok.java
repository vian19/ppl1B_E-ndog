 ...
 * @author Vian
 */
public class melihatstok extends javax.swing.JFrame {

    /**
     * Creates new form melihatstok
     */
    public melihatstok() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 130, 640, 390));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/Stok Barang.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(melihatstok.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new melihatstok().setVisible(true);
            }
        });
    }
